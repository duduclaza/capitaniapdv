<?php $pageTitle = 'Movimentações'; ?>
<div class="space-y-5 fade-in-up">
    <h2 class="text-lg font-bold text-white">Relatório de Movimentações de Estoque</h2>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-white/5">
                ...
                <?php else: foreach ($historico as $h):
                    $c = match($h['tipo']) { 'entrada' => 'text-emerald-400', 'saida' => 'text-red-400', 'ajuste' => 'text-blue-400', default => 'text-amber-400' };
                ?>
