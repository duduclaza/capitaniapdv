...
<div class="max-w-lg mx-auto fade-in-up">
    <div class="glass-card rounded-2xl p-8 text-center mt-4">
        <div class="w-20 h-20 rounded-full bg-fuchsia-900/30 flex items-center justify-center mx-auto mb-4">
            <i data-lucide="qr-code" class="w-10 h-10 text-fuchsia-400"></i>
        </div>
        ...
        <div class="bg-white p-4 rounded-2xl inline-block mb-4">
            <img src="<?= e($venda['qr_code_image']) ?>" alt="QR Code Pix" class="w-48 h-48 mx-auto">
        </div>
        <?php endif; ?>
